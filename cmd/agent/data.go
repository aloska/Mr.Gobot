...
Выходы
------
Похожи на входы, по сути, но вместо рецепторов - префекторы. И преффекторы не складывают данные в файл, а хранят в своем буфере,
который будет анализировать Эффектор
*/
